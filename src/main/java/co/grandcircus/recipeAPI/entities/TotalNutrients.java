...
@JsonPropertyOrder({ "ENERC_KCAL", "FAT", "FASAT", "FATRN", "FAMS", "FAPU", "CHOCDF", "FIBTG", "SUGAR", "SUGAR.added",
		"PROCNT", "CHOLE", "NA", "CA", "MG", "K", "FE", "ZN", "P", "VITA_RAE", "VITC", "THIA", "RIBF", "NIA", "VITB6A",
		"FOLDFE", "FOLFD", "VITB12", "VITD", "TOCPHA", "VITK1" })
public class TotalNutrients {
	...
	@JsonProperty("FATRN")
	private TotalValue fATRN;

	@JsonProperty("FAMS")
	private TotalValue fAMS;

	@JsonProperty("FAPU")
	private TotalValue fAPU;
	...
	@JsonProperty("SUGAR")
	private TotalValue sUGAR;

	@JsonProperty("SUGAR.added")
	private TotalValue sUGARAdded;
	...
	public TotalValue getfATRN() {

		return fATRN;
	}

	public void setfATRN(TotalValue fATRN) {

		this.fATRN = fATRN;
	}

	public TotalValue getfAMS() {

		return fAMS;
	}

	public void setfAMS(TotalValue fAMS) {

		this.fAMS = fAMS;
	}

	public TotalValue getfAPU() {

		return fAPU;
	}

	public void setfAPU(TotalValue fAPU) {
	...
	public TotalValue getsUGAR() {

		return sUGAR;
	}

	public void setsUGAR(TotalValue sUGAR) {

		this.sUGAR = sUGAR;
	}

	public TotalValue getsUGARAdded() {

		return sUGARAdded;
	}

	public void setsUGARAdded(TotalValue sUGARAdded) {
	...
	public TotalValue getfOLFD() {

		return fOLFD;
	}

	public void setfOLFD(TotalValue fOLFD) {
